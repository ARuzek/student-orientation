      ...
      2: [
        function (_dereq_, module, exports) {
          ...
          ;(IFrameMessageSender.prototype.send = function (message) {
            ...
            (IFrameMessageSender.prototype.cloneDeviceMotionEvent_ = function (
              e
            ) {
              return {
                acceleration: {
        ...
        function (_dereq_, module, exports) {
          function Player(selector, contentInfo) {
            ...
            ;(this.iframe = iframe),
              ...
              (this.isPaused = !1),
              (this.isMuted = !1),
              void 0 !== contentInfo.muted &&
                (this.isMuted = contentInfo.muted),
              (this.currentTime = 0),
              (this.duration = 0),
              (this.volume =
                void 0 != contentInfo.volume ? contentInfo.volume : 1),
          ...
          ;((Player.prototype = new EventEmitter()).addHotspot = function (
            ...
            (Player.prototype.getEmbedUrl_ = function () {
              ...
              return split.slice(0, split.length - 2).join('/') + '/index.html'
            }),
